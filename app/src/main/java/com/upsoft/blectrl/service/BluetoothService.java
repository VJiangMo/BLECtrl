...
public class BluetoothService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(Msg.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        Message msg = mHandler.obtainMessage(Msg.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(Msg.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(Msg.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(Msg.TOAST, "无法连接到蓝牙设备");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(Msg.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(Msg.TOAST, "蓝牙连接已断开");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private class ConnectedThread extends Thread {
            ...
            while (true) {
                try {
                    ...
                    for(int i = 0; i < s.length(); i++){
                        ...
                        msg = msg + x;
                        if (x == 0x3e) {
                            mHandler.obtainMessage(Msg.MESSAGE_READ, buffer.length, -1, msg).sendToTarget();
                            msg="";
                        }
                    }
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(Msg.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
